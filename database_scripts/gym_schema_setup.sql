...
CREATE USER gymadmin IDENTIFIED BY gympassword
DEFAULT TABLESPACE users
TEMPORARY TABLESPACE temp
QUOTA UNLIMITED ON users;

GRANT CONNECT, RESOURCE, CREATE VIEW, CREATE PROCEDURE TO gymadmin;

-- Connect as gymadmin
CONNECT gymadmin/gympassword@localhost:1521/XEPDB1
...
BEGIN
    ...
    VALUES (p_member_id, p_trainer_id, p_session_date, p_start_time, p_end_time)
